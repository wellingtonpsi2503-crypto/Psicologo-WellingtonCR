...
export const siteConfig = {
  ...
  // Agenda
  calendly: import.meta.env.VITE_CALENDLY_URL || "https://calendar.google.com/calendar/appointments/schedules/AcZssZ0hDU1CkBIygf-Zz4CKrt-MHB01AwavDUmzU52R8XVaziJZ1_daBO5xs-gkCtNMjwI7yvuSBbxt?gv=true",
  agendaExternal: import.meta.env.VITE_AGENDA_EXTERNAL_URL || "https://agenda-de-atendimento.netlify.app/",
  ...
  seo: {
    ...
    description: "Atendimento online e presencial em Logoterapia e clínica existencial com Francisco Wellington CR. Uma escuta orientada por sentido, presença e responsabilidade diante da vida.",
    privacyTitle: "Ética, Sigilo, Privacidade e Proteção de Dados | Francisco Wellington CR",
    privacyDescription: "Informações sobre sigilo profissional, atendimento on-line, privacidade e proteção de dados no site de Francisco Wellington CR.",
    approachTitle: "Abordagem e Pilares | Francisco Wellington CR",
    approachDescription: "Página dedicada à Logoterapia e à Psicologia Existencial, com apresentação da abordagem, pilares centrais e referências de aprofundamento.",
  },
...
export const contentData = {
  ...
  officialReferences: [
    ...
    },
    {
      ...
      text: "Lei nº 13.709/2018 que trata sobre proteção de dados pessoais no Brasil. Texto oficial disponibilizado pelo Planalto.",
